...
ENT.Hull = {-- The size of the mech's collision hull, this is only used for movement. Keep it off the ground so it doesn't catch on any bumps
	Mins = Vector(-52, -52, -35),
	Maxs = Vector(52, 52, 145)
}

ENT.GroundOffset = 160 -- How far above the ground the mech sits
...
ENT.WalkSpeed = 160 -- The target speed when walking normally
ENT.RunSpeed = 300 -- The target speed when +speed is held down

ENT.TurnRate = 70 -- [MoveStat] Degrees/s the mech can turn

-- Gait/leg related fields
ENT.StepSize = 320 -- [MoveStat] The forward length of each step the mech takes
ENT.Stance = {0.45, 0.55} -- [MoveStat] Fraction of time each leg spends in the air
ENT.ForwardLean = 1.1 -- [MoveStat] How far off-center the mech's legs are when moving
