...
if SERVER then
	...
	self:AddHitbox("LeftWeapon", Vector(-28, 11, 5),  Angle(0, 0, -90), Vector(60, 47, 30))
	self:AddHitbox("RightWeapon", Vector(-28, -11, 5), Angle(0, 0, 90),  Vector(60, 47, 30))
...
function ENT:BuildDamageGroups()
	...
	self:AddDamageGroup("Left Leg", 4, {"LHip", "LKnee", "LFoot"})
	self:AddDamageGroup("Right Leg ", 4, {"RHip", "RKnee", "RFoot"})
end
